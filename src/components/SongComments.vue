...
<!--        </div>-->
        <div class="hot-area">
          <div class="hot-area-item" v-for="(item, index) in getHotSongComment"
               :key="item.id">
          ...
          <div class="hot-area-item" v-for="(item, index) in getSongComment"
               :key="index">
            <div class="user-avatar">
              <el-avatar shape="circle" size="medium" class="userAvatar"
                         :src="item.user.avatarUrl"/>
...
export default {
  ...
  props: ['getSongComment', 'getHotSongComment'],
  data () {
    // 这里存放数据
    return {
      isLoading: false,
